...
#------------------------------
    ...
    clawdata.upper[0] = 140.0          # xupper
    clawdata.lower[1] = -6.0          # ylower
    clawdata.upper[1] = 8.0          # yupper
    
    # Number of grid cells:
    clawdata.num_cells[0] = 200      # mx
    clawdata.num_cells[1] = 28      # my
    ...
    #   4 or 'mc'       ==> MC limiter
    clawdata.limiter = ['mc', 'mc', 'mc', 'mc', 'mc']
    ...
    # Gauges:
    # ---------------
    rundata.gaugedata.gauges = [[2, 2.0, 1.0, 0.0, 60000.0], [32, 32.0, 1.0, 0.0, 60000.0], [66, 66.0, 1.0, 0.0, 60000.0], [90, 90.0, 1.0, 0.0, 60000.0], [80, 80.0, 1.0, 0.0, 60000.0]]
    ...
    amrdata.refinement_ratios_x = [5, 5, 2, 4]
    amrdata.refinement_ratios_y = [5, 5, 2, 4]
    amrdata.refinement_ratios_t = [5, 5, 2, 4]


    # Specify type of each aux variable in amrdata.auxtype.
    # This must be a list of length num_aux, each element of which is one of:
    #   'center',  'capacity', 'xleft', or 'yleft'  (see documentation).
    amrdata.aux_type = ['center', 'center', 'yleft', 'center', 'center', 'center', 'center', 'center', 'center']
...
#-------------------
    ...
    geo_data.friction_depth = 10000.0
    ...
    # == settopo.data values ==
    rundata.topo_data.topofiles = [[2, 1, 3, 0.0, 10000000000.0, 'topo/ZeroTopo.tt2'], [2, 2, 3, 0.0, 10000000000.0, 'topo/Wall1Topo.tt2'], [2, 2, 3, 0.0, 10000000000.0, 'topo/Wall2Topo.tt2'], [2, 4, 4, 0.0, 5.0, 'topo/ZeroTopoGate.tt2']]
    ...
    rundata.qinit_data.qinitfiles = [[2, 7, 3, 3, 'topo/FlumeQinit.tt2']]
...
def setdig(rundata):
    ...
    try:
        debris_data = rundata.debris_data
        pressure_data = rundata.pressure_data
    except:
    ...
    debris_data.c1 = 1.0
    debris_data.rho_f = 1100.0
    debris_data.rho_s = 2700.0
    debris_data.phi_bed = 40.0
    debris_data.theta_input = 0.0
    debris_data.mu = 0.005
    debris_data.m0 = 0.61
    debris_data.m_crit = 0.64
    debris_data.delta = 1.e-3
    permeability = 1.e-10
    debris_data.kappita = permeability*np.exp((debris_data.m0-0.60)/(0.04))
    debris_data.alpha_c = 0.05
    debris_data.alpha_seg = 1.0
    debris_data.sigma_0 = 1.e3
    debris_data.bed_normal = 1

    pressure_data.init_ptype = 0
    pressure_data.init_pmax_ratio = 0.0
    pressure_data.init_ptf  = 0.0
    pressure_data.init_ptf2 = 0.0
